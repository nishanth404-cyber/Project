# for command_line Argument and exiting
import sys
# for networking interface and ip operations
import socket
# for ip network calculations
import ipaddress
# for parallel thread executoin
import concurrent.futures
# for detectiong operation system
import platform
# for running os commands   
import subprocess
# for regular expressions
import re
# for possible future os operation
import os

#&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&

def print_app_name(): #ascii art generator
     print('''
...
def mask_to_cidr(mask):
    """
    converts a dotted-decimal subnet mask (eg., 255.255.255.0) to Cidr notation(e.g., 24),
    """
